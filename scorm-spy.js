javascript:(function()
{
  console.log('🚀 Скрипт SCORM Spy загружен, начинаем выполнение...');
try {
    // Далее идёт весь остальной код
    if(window.__scormSpyActive) {
        console.log('⚠️ Скрипт уже был активен, завершаем работу');
        return;
    }
    console.log('✅ Продолжаем выполнение, __scormSpyActive не установлен');
    // ... остальной код ...
